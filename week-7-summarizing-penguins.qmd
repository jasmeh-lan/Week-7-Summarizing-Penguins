...
```{r}
#| label: Group by Species and Sex
#| message: false
...
```{r}
#| label: Summary Table For Chinstrap
...
```{r}
#| label: Summary Table of Bill Ratio
...
```{r}
#| label: Table of Biscoe Species Mean
...
```{r}
#| label: Counting Adelie and Gentoo Penguins
...
```{r}
#| label: Chinstrap Flipper Length - Body Mass Ratio
